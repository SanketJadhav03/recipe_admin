...
function DesiredProductUpdate(props) {
  const [desiredproduct, setDesiredProduct] = useState(props.edit_data)
    ...
    <Modal size="md" isOpen={props.modalStates} toggle={props.setModalStates} centered>
      ...
      <ModalBody className="rounded">
        <div className="p-2">
          {/* ENGLISH */}
          <div className="mb-3">
            <div className="fw-bold mb-2">Desired Product (English)</div>
            <input
          ...
          {/* MARATHI */}
          <div className="mb-3">
            <div className="fw-bold mb-2">Desired Product (Marathi)</div>
            <input
              className="form-control"
          ...
          {/* HINDI */}
          <div className="mb-3">
            <div className="fw-bold mb-2">Desired Product (Hindi)</div>
            <input
              className="form-control"
...
export default DesiredProductUpdate
